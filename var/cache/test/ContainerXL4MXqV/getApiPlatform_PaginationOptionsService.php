...
class getApiPlatform_PaginationOptionsService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.pagination_options'] = new \ApiPlatform\State\Pagination\PaginationOptions(true, 'page', false, 'itemsPerPage', false, 'pagination', 10, NULL, false, false, 'partial');
    }
}
